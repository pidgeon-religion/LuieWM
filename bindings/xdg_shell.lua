...
struct wlr_xdg_popup_state {
    struct wlr_box geometry; // relative to the parent window geometry origin
    bool reactive;
};
...
struct wlr_xdg_positioner_rules {
    ...
    struct { int32_t width, height; } parent_size;
...
}; // trailing WLR_PRIVATE omitted, never accessed
